...
train_dataset = load_from_disk('data/train_dataset_tokenized')
test_dataset = load_from_disk('data/test_dataset_tokenized')
...
train_dataset.save_to_disk('data/train_dataset_labeled')
test_dataset.save_to_disk('data/test_dataset_labeled')
